        ...
        .then((out) => {
            ...
            $.each(out, function(index, value) {
				...
				if(value.status=="Por aprovar"||value.status=="Por avaliar"){
					$('#tableActivities tbody').append('<tr><td>' + value.title + '</td> <td class="d-none d-xl-table-cell">'+ value.init_data+'</td><td class="d-none d-xl-table-cell">'+ value.end_data+'</td><td><span class="badge bg-warning">Por avaliar</span></td><td class="d-none d-md-table-cell">'+value.activityType+'</td></tr>')
				}
